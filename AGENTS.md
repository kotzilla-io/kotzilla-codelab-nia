...
This variant replaces Dagger Hilt with **Koin** (Koin Compiler Plugin) and is monitored by the
**Kotzilla Platform**. For performance, crash, or DI investigations, prefer the **Kotzilla MCP
server** (issues, issue context, screen performance, fix guidance) as the evidence source over
...
- The project uses git. The upstream original project is https://github.com/android/nowinandroid.
